...
public class UnionIntersectioTwoLL {
    ...
    {
    	UnionIntersectioTwoLL llist1 = new UnionIntersectioTwoLL();
    	UnionIntersectioTwoLL llist2 = new UnionIntersectioTwoLL();
    	UnionIntersectioTwoLL unin = new UnionIntersectioTwoLL();
    	UnionIntersectioTwoLL intersecn = new UnionIntersectioTwoLL();
